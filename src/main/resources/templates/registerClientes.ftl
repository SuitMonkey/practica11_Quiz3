        ...
        <div class="mdl-grid demo-content">
            <div class="mdl-cell mdl-cell--4-col" style="display: inline-block;">
                ...
                <#list clients?sort_by("lastName") as client>
                    <tr>
                        ...
                        <#if client.getPhoto()??><td><img src="data:image/jpg;base64,${client.getPhoto()}" alt="Image" style="max-width: 100px; max-height: 100px;" /></td><#else><td>No Image Available</td></#if>
            ...
            <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                <form action="/editClient" METHOD="POST" enctype="multipart/form-data">
                    <div class="mdl-card__title">
                        <h2 class="mdl-card__title-text">Edit Client Photo</h2>
                    </div>
                    <div class="mdl-card__supporting-text">
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                            <input class="mdl-textfield__input" type="text" id="idP" name="idP">
