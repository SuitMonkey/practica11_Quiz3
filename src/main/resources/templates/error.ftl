...
<div class="demo-card-wide mdl-card mdl-shadow--2dp" style="margin-top:25%; margin:0 auto;">
    <div class="mdl-card__title">
        <#if (status)??>
            <#if (error)??>
                <h2 class="mdl-card__title-text">Sorry, we are...a  ${status} ${error} you have</h2>
            <#else>
                <h2 class="mdl-card__title-text">Sorry, we are...a  ${status}, Bad error, you have</h2>
            </#if>
        <#else>
            <h2 class="mdl-card__title-text">Sorry, we are...a  bad status and error you have</h2>
        </#if>
